...
PROSTARS helps children build confidence, try new things, and feel proud of themselves — through fun movement and play, once a week. It's a fresh, ownable brand: not a Playball re-run, not a re-skin of the earlier `Proteus` prototype.
...
- `WhatsApp Chat with Lal New Zealand.txt` — source conversation this brand strategy was extracted from (founder's own words: vision, frustrations, business goals)
- `docs/` — everything above

## Related repos
- [`911duplessis/Mullers`](https://github.com/911duplessis/Mullers) — the founder's documentation hub, indexing all of her in-flight projects (PROSTARS is one of several)
- `iamstiaan/Proteus` — an earlier, quickly-built prototype (different GitHub identity, same person) that PROSTARS deliberately supersedes rather than extends — see `00_INDEX/MIGRATION_PLAN.md` in the Mullers repo for the audit and recommendation
